...
#> [frontmatter]
#> title = "HW1 - Getting Started and Multiple Dispatch"
#> date = "2026-09-14"
...
HW1 release date: Monday, Sep 14, 2026.

**HW1 due date: Monday, Sep 21, 2026, 11:59pm EST.**
...
We'd like everyone to **submit this first homework assignment**. The first part will help you get everything running smoothly, and the second part begins our work with Julia's type system and multiple dispatch.
...
Homework notebooks (as opposed to presentations) will be released on Mondays and due the following Monday at 11:59pm Eastern time.

The first part is for you to get your system set up correctly and to test your submission workflow. You must submit the complete notebook, and it counts as part of the homework grade.
"""

# ╔═╡ f9d7250a-706f-11eb-104d-3f07c59f7174
md"## Requirements of Part 1
...
md"""
# Part 2: Pokémon - _gotta dispatch 'em all_
"""
