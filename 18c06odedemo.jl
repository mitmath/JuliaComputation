...
# ╔═╡ 77db76b5-b348-4e0f-9473-1844567334bf
import AbstractPlutoDingetjes: AbstractPlutoDingetjes, Bonds

# ╔═╡ f4ac45a2-925c-11ef-09b1-9db2a5db91e8
md"c = $(@bind c Slider(-10:10; default=1, show_value=true))" # this is the y intercept

# ╔═╡ 402cba04-1c7c-4844-90e9-339c7dac0935
md"a = $(@bind a Slider(-3:.1:3; default=1, show_value=true))"

# ╔═╡ b7860f5c-efe1-44d2-81d4-fffa496c748e
let

  plot(t -> exp(a*t)*c, 0, 5, label=false, ylims=[-10,10], xlims=[0,5])
  xlabel!("t")
  ylabel!("x")
  title!( "x = ceᵃᵗ, c=$c, a=$a" )
end

# ╔═╡ be01fef4-f691-40f0-a2e2-c38c1006db51
...
# ╔═╡ f60393bb-ea8c-48be-84ca-6529c4f09693
begin
...
# ╔═╡ 1b447db1-60a0-4120-8fcb-21189ff1f755
...
# ╔═╡ 8a778345-baec-4d96-8cd6-734fd3660618
...
# ╔═╡ ae4b08de-9afb-4ba2-95b4-3bfb3050194c
Z = scrub_matrix([1 2;3 4])
...
manifest_format = "2.0"
project_hash = "f2040e9941d94e0f939ed3aac4a241499d5713ed"
