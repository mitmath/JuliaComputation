...
# ╔═╡ 9260ed2e-5a0c-11ed-3cd6-0ff639b38f1c
using CUDA, KernelAbstractions, CUDAKernels, BenchmarkTools

# ╔═╡ 6ed42e7e-3bbb-4fc9-95fb-509b08d2d53d
force_law(x,y) = 1/abs(x-y)

# ╔═╡ 76fbcfe3-7962-4f99-b70d-9bcc3bed07e4
...
# ╔═╡ 78754f69-56d8-4cce-b500-704656530711
 kernel! = myproblem!(CUDADevice(),256)

# ╔═╡ 700d5233-fee9-415c-b757-322d014a4a23
# @time myproblem1(Array(positions))

# ╔═╡ b1d4465d-7d65-411d-ba33-632bb1eb2ace
n = 8_000_000

# ╔═╡ 6aa011fa-bb3b-4057-bb26-2b898465b359
begin
	positions = rand(n)
	forces = similar(positions)
end

# ╔═╡ 2dc55a8e-0837-4f35-8191-e70a54e7ca7e
positionsGPU = CuArray(positions)

# ╔═╡ 6b390849-1959-445b-bc7f-c5352db0890a
forcesGPU = CuArray(forces)

# ╔═╡ 19c602c1-9800-4d74-9c56-deab17e54df7
begin
  @time wait(kernel!(forcesGPU, positionsGPU, force_law, ndrange=n))
	forcesGPU
end

# ╔═╡ 4559bcc6-a8a8-4bd7-a464-5b430258ce43
(n * 4*8)/2^30

# ╔═╡ 661d35c0-4d0c-4748-917a-6d599c821de0
